...
import { localRaces, mayorBallot } from "@/data/localRaces";

type Language = "en" | "es";

const copy = {
  en: {
    eyebrow: "The 2026 ballot",
    title: "Every Laredo race. Every name.",
    ...
    open: "Open guide",
    disclaimer: "Names follow the supplied ballot-drawing boards. Districts 1 and 6 include visible verification notices where current public records require another check.",
  },
  es: {
    eyebrow: "La boleta de 2026",
    title: "Cada contienda. Cada nombre.",
    ...
    open: "Abrir guía",
    disclaimer: "Los nombres siguen los tableros del sorteo proporcionados. Los Distritos 1 y 6 incluyen avisos visibles donde los registros públicos requieren otra verificación.",
  },
} as const;

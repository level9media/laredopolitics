...
export function EnglishMissingResource() {
  return (
    <PageShell language="en">
      <Seo title="Page not found" description="The requested page does not exist on Laredo Mayor." path="/404" />

...
export function ElectionOverview() {
  return (
    <PageShell language="es">
      <Seo language="es" title="Elección de alcalde de Laredo 2026: guía completa" description="Guía completa de la elección de alcalde de Laredo del 3 de noviembre de 2026: candidatos, comparación, temas, fechas y cómo votar." path="/es/eleccion-alcalde-laredo-2026" keywords={["Laredo mayor election 2026", "elección alcalde Laredo 2026", "Laredo mayor candidates"]} schema={{ "@context": "https://schema.org", "@type": "Event", name: "2026 Laredo Mayoral Election", startDate: "2026-11-03", eventStatus: "https://schema.org/EventScheduled", location: { "@type": "Place", name: "Laredo, Texas" }, url: `${SITE_URL}/es/eleccion-alcalde-laredo-2026` }} />
...
export function StaticResourcePage({ kind }: { kind: StaticKind }) {
  ...
  return (
    <PageShell language="es">
      <Seo language="es" title={`${page.title} | Laredo Mayor 2026`} description={page.description} path={page.path} keywords={[page.title, "Laredo politics", "Laredo mayor 2026"]} schema={{ "@context": "https://schema.org", "@type": "WebPage", name: page.title, description: page.description }} />
...
export function MissingResource() {
  return (
    <PageShell language="es">
      <Seo language="es" title="Página no encontrada" description="La página solicitada no existe en Laredo Mayor." path="/404" />
